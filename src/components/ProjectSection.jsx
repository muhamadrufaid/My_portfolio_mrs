...
const projects = [
    {
        id: 1,
        title: "BizCore. A billing Web app",
        description: "The smart way to run your business",
        image: "/projects/BizCore-cover-img.png",
    ...
    },
    {
        ...
        description: "A smartest way to run your business",
        image: "/projects/BIZCOREOVERVIEW.png",
        tags: ["React", "TailwindCSS", "Python"],
        demoUrl: "#",
        githubUrl: "#",
    },
        ...
        <section id="projects" className="py-24 px-4 relative">
            <div className='container mx-auto max-w-5xl'>
                ...
                <div className='text-center mt-12'>
                    ...
                    <a href="https:github.com/samplelink"
                        target='_blank'
